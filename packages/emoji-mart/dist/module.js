...
function $7932d8512872cd34$var$remove(emoji) {
    $7932d8512872cd34$var$List || ($7932d8512872cd34$var$List = (0, $f72b75cf796873c7$export$2e2bcd8739ae039).get("favorites") || []);
    const emojiId = emoji.id || emoji;
    if (!emojiId) return;
    const index = $7932d8512872cd34$var$List.indexOf(emojiId);
    if (index === -1) return;
    $7932d8512872cd34$var$List.splice(index, 1);
    (0, $f72b75cf796873c7$export$2e2bcd8739ae039).set("favorites", $7932d8512872cd34$var$List);
}
function $7932d8512872cd34$var$toggle(emoji) {
    const emojiId = emoji.id || emoji;
    if ($7932d8512872cd34$var$has(emojiId)) {
        $7932d8512872cd34$var$remove(emoji);
        return {
            added: false
        };
    } else {
        $7932d8512872cd34$var$add(emoji);
        return {
            added: true
        };
    }
}
function $7932d8512872cd34$var$get() {
    $7932d8512872cd34$var$List || ($7932d8512872cd34$var$List = (0, $f72b75cf796873c7$export$2e2bcd8739ae039).get("favorites") || []);
    return [
...
$8d50d93417ef682a$exports = JSON.parse('{"search":"Search","search_no_results_1":"Oh no!","search_no_results_2":"That emoji couldn\u2019t be found","pick":"Pick an emoji\u2026","add_custom":"Add custom emoji","categories":{"activity":"Activity","custom":"Custom","flags":"Flags","foods":"Food & Drink","favorites":"Favorites","frequent":"Frequently used","nature":"Animals & Nature","objects":"Objects","people":"Smileys & People","places":"Travel & Places","search":"Search Results","symbols":"Symbols"},"skins":{"1":"Default","2":"Light","3":"Medium-Light","4":"Medium","5":"Medium-Dark","6":"Dark","choose":"Choose default skin tone"}}');
...
async function $7adb23b0109cc36a$var$_init(props) {
    ...
    while(categoryIndex--){
        ...
        if (category.id == "favorites") category.emojis = (0, $7932d8512872cd34$export$2e2bcd8739ae039).get();
...
class $89bd6bb200cc8fef$export$2e2bcd8739ae039 extends (0, $fb96b826c0c5f37a$export$16fa2f45be04daa8) {
    ...
    componentWillMount() {
        ...
        if (this.props.favorites) {
            (0, $7932d8512872cd34$export$2e2bcd8739ae039).set(this.props.favorites);
    ...
    componentWillReceiveProps(nextProps) {
        ...
        this.nextStateTimer = setTimeout(()=>{
            ...
            for(const k in this.nextState){
                ...
                if (k === "favorites") {
                    (0, $7932d8512872cd34$export$2e2bcd8739ae039).set(this.nextState[k]);
    ...
    handleFavoriteToggle(emoji, target) {
        ...
        const { added: added  } = (0, $7932d8512872cd34$export$2e2bcd8739ae039).toggle(emojiId);
        if (target) this.showFavoriteAnimation(target, added);
        if (this.props.onFavoriteChange) {
            const emojiData = (0, $693b183b0a78708f$export$d10ac59fbe52a745)(emoji, {
                skinIndex: this.state.skin - 1
            });
            this.props.onFavoriteChange((0, $7932d8512872cd34$export$2e2bcd8739ae039).get(), emojiData, added ? "add" : "remove");
        }
        this.refreshFavoritesCategory();
    }
    ...
    refreshFavoritesCategory() {
        ...
        if (favCategory) {
            favCategory.emojis = (0, $7932d8512872cd34$export$2e2bcd8739ae039).get();
            if (!favCategory.emojis.length) {
                const idx = categories.indexOf(favCategory);
                if (idx !== -1) categories.splice(idx, 1);
            }
        } else {
            const favoriteEmojis = (0, $7932d8512872cd34$export$2e2bcd8739ae039).get();
    ...
    constructor(props){
        ...
        (0, $c770c458706daa72$export$2e2bcd8739ae039)(this, "handlePointerDown", (emoji, e)=>{
        ...
        (0, $c770c458706daa72$export$2e2bcd8739ae039)(this, "handlePointerMove", (e)=>{
        ...
        (0, $c770c458706daa72$export$2e2bcd8739ae039)(this, "handlePointerUp", ()=>{
            clearTimeout(this.longPressTimer);
            this.longPressTimer = null;
        });
        (0, $c770c458706daa72$export$2e2bcd8739ae039)(this, "handlePointerLeave", ()=>{
            clearTimeout(this.longPressTimer);
            this.longPressTimer = null;
        });
