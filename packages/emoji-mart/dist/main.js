...
$parcel$export(module.exports, "Favorites", function () { return $4000c4e330959fe1$export$2e2bcd8739ae039; });
...
function $4000c4e330959fe1$var$remove(emoji) {
    $4000c4e330959fe1$var$List || ($4000c4e330959fe1$var$List = (0, $000e3cabb83607f9$export$2e2bcd8739ae039).get("favorites") || []);
    var emojiId = emoji.id || emoji;
    if (!emojiId) return;
    var index = $4000c4e330959fe1$var$List.indexOf(emojiId);
    if (index === -1) return;
    $4000c4e330959fe1$var$List.splice(index, 1);
    (0, $000e3cabb83607f9$export$2e2bcd8739ae039).set("favorites", $4000c4e330959fe1$var$List);
}
function $4000c4e330959fe1$var$toggle(emoji) {
    var emojiId = emoji.id || emoji;
    if ($4000c4e330959fe1$var$has(emojiId)) {
        $4000c4e330959fe1$var$remove(emoji);
        return {
            added: false
        };
    } else {
        $4000c4e330959fe1$var$add(emoji);
        return {
            added: true
        };
    }
}
function $4000c4e330959fe1$var$get() {
    $4000c4e330959fe1$var$List || ($4000c4e330959fe1$var$List = (0, $000e3cabb83607f9$export$2e2bcd8739ae039).get("favorites") || []);
...
$128a97276525cf7f$exports = JSON.parse('{"search":"Search","search_no_results_1":"Oh no!","search_no_results_2":"That emoji couldn\u2019t be found","pick":"Pick an emoji\u2026","add_custom":"Add custom emoji","categories":{"activity":"Activity","custom":"Custom","flags":"Flags","foods":"Food & Drink","favorites":"Favorites","frequent":"Frequently used","nature":"Animals & Nature","objects":"Objects","people":"Smileys & People","places":"Travel & Places","search":"Search Results","symbols":"Symbols"},"skins":{"1":"Default","2":"Light","3":"Medium-Light","4":"Medium","5":"Medium-Dark","6":"Dark","choose":"Choose default skin tone"}}');
        ...
        return (0, (/*@__PURE__*/$parcel$interopDefault($f5fc4923ef4118c4$exports))).wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                ...
                case 58:
                    ...
                    return _ctx.abrupt("continue", 58);
                case 65:
                ...
                case 81:
                    ...
                    throw _iteratorError;
                case 84:
                    return _ctx.finish(81);
                case 85:
                    return _ctx.finish(78);
                case 86:
                    _ctx.next = 58;
                    break;
                case 88:
                ...
                case 94:
                    ...
                    if (category1.id == "favorites") category1.emojis = (0, $4000c4e330959fe1$export$2e2bcd8739ae039).get();
                    ...
                    return _ctx.abrupt("continue", 94);
                case 101:
                ...
                case 104:
                    ...
                    ignore();
                    return _ctx.abrupt("continue", 104);
                case 111:
                ...
                case 125:
                    ...
                    return _ctx.abrupt("continue", 130);
                case 129:
                ...
                case 151:
                    ...
                    return _ctx.abrupt("continue", 160);
                case 155:
                    skinIndex++;
                    native = skin.native;
                    if (native) {
...
var $b9ae2abd9272dd52$var$categories = {
    ...
    favorites: {
        ...
        solid: /*#__PURE__*/ (0, $55ec52987511209e$export$34b9dba7ce09269b)("svg", {
            ...
            viewBox: "0 0 576 512",
            children: /*#__PURE__*/ (0, $55ec52987511209e$export$34b9dba7ce09269b)("path", {
                d: "M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329l-24.6 145.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.2 329l104.3-103.1c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381 150.3 316.9 18z"
            })
        })
    },
    frequent: {
...
var $75afa6943437e26f$export$2e2bcd8739ae039 = /*#__PURE__*/ function(Component1) {
    ...
    function Picker(props) {
        ...
        (0, (/*@__PURE__*/$parcel$interopDefault($gntqc)))((0, (/*@__PURE__*/$parcel$interopDefault($5MCow)))(_this), "handlePointerDown", function(emoji, e) {
            _this.longPressTriggered = false;
            ...
            _this.longPressTimer = setTimeout(function() {
                _this.longPressTriggered = true;
                _this.handleFavoriteToggle(emoji, target);
            }, _this.props.longPressDuration || 500);
        });
        (0, (/*@__PURE__*/$parcel$interopDefault($gntqc)))((0, (/*@__PURE__*/$parcel$interopDefault($5MCow)))(_this), "handlePointerMove", function(e) {
            if (!_this.longPressTimer || !_this.pointerDownPos) return;
            var dx = e.clientX - _this.pointerDownPos.x;
            var dy = e.clientY - _this.pointerDownPos.y;
            if (dx * dx + dy * dy > 100) {
                clearTimeout(_this.longPressTimer);
                _this.longPressTimer = null;
            }
        });
        (0, (/*@__PURE__*/$parcel$interopDefault($gntqc)))((0, (/*@__PURE__*/$parcel$interopDefault($5MCow)))(_this), "handlePointerUp", function() {
            clearTimeout(_this.longPressTimer);
            _this.longPressTimer = null;
        });
        (0, (/*@__PURE__*/$parcel$interopDefault($gntqc)))((0, (/*@__PURE__*/$parcel$interopDefault($5MCow)))(_this), "handlePointerLeave", function() {
            clearTimeout(_this.longPressTimer);
            _this.longPressTimer = null;
        });
    ...
    (0, (/*@__PURE__*/$parcel$interopDefault($bf5a3d69977e47ef$exports)))(Picker, [
        ...
        },
        {
            ...
            value: function componentWillMount() {
                ...
                if (this.props.favorites) {
                    (0, $4000c4e330959fe1$export$2e2bcd8739ae039).set(this.props.favorites);
            ...
            value: function componentWillReceiveProps(nextProps) {
                ...
                this.nextStateTimer = setTimeout(function() {
                    ...
                    for(var k in _this.nextState){
                        ...
                        if (k === "favorites") {
                            (0, $4000c4e330959fe1$export$2e2bcd8739ae039).set(_this.nextState[k]);
        ...
        },
        {
            ...
            value: function handleFavoriteToggle(emoji, target) {
                var emojiId = emoji.id;
                var added = (0, $4000c4e330959fe1$export$2e2bcd8739ae039).toggle(emojiId).added;
                if (target) this.showFavoriteAnimation(target, added);
                if (this.props.onFavoriteChange) {
                    var emojiData = (0, $0542300b6c56b62c$export$d10ac59fbe52a745)(emoji, {
                        skinIndex: this.state.skin - 1
                    });
                    this.props.onFavoriteChange((0, $4000c4e330959fe1$export$2e2bcd8739ae039).get(), emojiData, added ? "add" : "remove");
                }
                this.refreshFavoritesCategory();
            }
        },
        {
            key: "showFavoriteAnimation",
            value: function showFavoriteAnimation(target, added) {
        ...
        {
            key: "refreshFavoritesCategory",
            value: function refreshFavoritesCategory() {
                var _this = this;
                var categories = (0, $47b4a70d4572a3b3$export$2d0294657ab35f1b).categories;
                var favCategory = categories.find(function(c) {
                    return c.id === "favorites";
                });
                if (favCategory) {
                    favCategory.emojis = (0, $4000c4e330959fe1$export$2e2bcd8739ae039).get();
                    if (!favCategory.emojis.length) {
                        var idx = categories.indexOf(favCategory);
                        if (idx !== -1) categories.splice(idx, 1);
                    }
                } else {
                    var favoriteEmojis = (0, $4000c4e330959fe1$export$2e2bcd8739ae039).get();
                ...
                return /*#__PURE__*/ (0, $55ec52987511209e$export$34b9dba7ce09269b)((0, $caeffba843b1695e$export$2e2bcd8739ae039), {
                    ...
                    children: /*#__PURE__*/ (0, $55ec52987511209e$export$34b9dba7ce09269b)("button", {
                        ...
                        onMouseLeave: function() {
                            _this.handleEmojiOver();
                            _this.handlePointerLeave();
                        },
                        onPointerDown: function(e) {
                            return _this.handlePointerDown(emoji, e);
                        },
